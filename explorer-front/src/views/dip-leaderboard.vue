...
.banner {
  ...
  background: url(/static/img/dip_list_banner_bg.jpg?v=20190117) no-repeat
    bottom;
  ...
  <div class="dip-leaderboard fullfill">
    <div class="container">
      <!-- <div class="banner font-color-FFFFFF">
				...
				<div class="title font-36 font-bold"></div>
      ...
      <div
        class="week-label d-inline-flex justify-content-between align-items-center"
        data-toggle="collapse"
        data-target="#week-selector"
        aria-expanded="false"
        aria-controls="week-selector"
        @click="weekLabelClick($event)"
      >
        <span class="font-color-000000 font-14 p-0 mr-auto">{{
          weekText
        }}</span>
        <img
          class="p-0"
          src="/static/img/ic_payload_arrow_down.png"
          alt=""
          width="16px"
        />
      </div>
      <div id="week-selector" class="collapse">
        <vue-week-selector
          ...
          v-model="beginDate"
          tabindex="0"
          @blur="dismissWeekSelector"
          @change="dismissWeekSelector"
        ></vue-week-selector>
      </div>
      <span
        v-if="totalContract && totalAward"
        ...
        <table class="explorer-table list-table">
          ...
          <tr v-for="(o, i) in arr" :key="i">
            <td class="px-3 text-center">
              <img
                v-if="o.rank < 3"
                :src="'../../static/img/dip_list_' + o.rank + '.png'"
                width="26px"
              />
