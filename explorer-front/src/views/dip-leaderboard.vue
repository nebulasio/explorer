	...
	<div class="dip-leaderboard fullfill">
		<div class="container">
			...
			<div class="top font-color-000000">
				<div class="title font-40 font-bold diplocalizable" id="dipTitle">Native Developer Incentive Protocol Awards</div>
			...
			<span v-if="totalContract && totalAward" class="font-14 font-color-666666 d-block d-md-inline mt-4 mt-md-0">
				<span class="font-bold font-color-333333">{{ totalContract }}</span> <span class="diplocalizable" id="dipRewardsText"></span>
					...
					<tr v-for="(o, i) in arr" :key="i">
						...
						<td class="tdxxxwddd txs-from-to">
							<div class="container-tip">
								<span class="tip down-arrow-tip font-15 shadow diplocalizable" id="dipSmartContractTitle"></span>
	...
	module.exports = {
		...
		methods: {
			...
			checkStaticTranslations() {
				...
				var myLocalizableElements = document.getElementsByClassName("diplocalizable");
			...
			checkDynamicTranslations() {
				...
				var myMultiLocalizableElements = document.getElementsByClassName("dipmultilocalizable");
