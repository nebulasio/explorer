    ...
    <div v-if="arr && arr.length" class="container mt20">
      <div class="align-items-center info-and-pagination mt20 row">
        <div class="col info font-color-000000 font-24 font-bold">
          ...
          <span>
            {{ $t("pendingTxPendingPrefix") }}
          </span>
          <span v-if="totalTxs == 1"> {{ $t("pendingTxPendingSuffix") }} </span
          ><span v-else>
            {{ $t("pendingTxPendingSuffixPlural") }}
          </span>
        </div>
      </div>
      <div class="explorer-table-container">
        <table class="mt20 explorer-table list-table">
          <tr class="list-header font-12 font-bold font-color-000000">
            ...
            <th>{{ $t("pendingTxTxLastSeen") }}</th>
            <th>{{ $t("pendingTxTxGasLimit") }}</th>
            <th>{{ $t("pendingTxTxGasPrice") }}</th>
            <th>{{ $t("pendingTxTxFrom") }}</th>
            <th></th>
            <th>{{ $t("pendingTxTxTo") }}</th>
