        ...
        <table class="mt20 explorer-table list-table">
          ...
          <tr v-for="(o, i) in arr" :key="i">
            ...
            <td
              ...
              class="text-right font-color-000000 font-14"
            >
              {{ natAmount(o) }} NAT
            </td>
            <td v-else class="text-right font-color-000000 font-14">
