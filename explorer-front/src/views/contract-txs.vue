	...
	<div class="vue-txs fullfill">
		...
		<div class="container mt20">
			<div class="align-items-center info-and-pagination mt20 row">
				<div class="col info font-color-000000 font-24 font-bold">{{ numberAddComma(totalTxs) }} <span class="contracttxslocalizable" id="contracttxsTransactionsFound"></span></div>
			</div>
			...
			<div class="explorer-table-container">
				<table v-if="arr.length" class="mt20 explorer-table list-table">
					<tr class="list-header font-12 font-bold font-color-000000">
						<th class="pl-2"></th>
						<th class="contracttxslocalizable" id="contracttxsTableTxHash"></th>
						<th class="contracttxslocalizable" id="contracttxsTableBlock"></th>
						<th class="contracttxslocalizable" id="contracttxsTableAge"></th>
						<th class="contracttxslocalizable" id="contracttxsTableFrom"></th>
						<th></th>
						<th class="contracttxslocalizable" id="contracttxsTableTo"></th>
						<th class="text-right contracttxslocalizable" id="contracttxsTableValue"></th>
						<th class="text-right pr-3 contracttxslocalizable" id="contracttxsTableTxFee"></th>
					</tr>
	...
	module.exports = {
		...
		methods: {
			...
			checkStaticTranslations() {
				...
				var myLocalizableElements = document.getElementsByClassName("contracttxslocalizable");
				...
				if(foo[1]=="contract-txs") {
					...
					for (i = 0; i < totalElements; i++) {
						myLocalizableElements[i].innerText = (this.tokenName ? this.tokenName + ' ' : '')  + jsonStrings[this.$selectedLanguage]["contracttxsTitle"];
					}
				}
			},
			checkDynamicTranslations() {
				// Multiple elements, identified with name attr
				var myMultiLocalizableElements = document.getElementsByClassName("contracttxsmultilocalizable");
