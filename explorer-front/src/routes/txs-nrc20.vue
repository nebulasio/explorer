		...
		<div class="vue-bread">
			<div class="container">
				<div class="row align-items-center">
					<div class="col-auto bread-title font-40 font-bold font-color-000000 nrc20localizable" id="nrc20Title"></div>
		...
		<div class="container mt20">
			<div class="align-items-center info-and-pagination mt20 row">
				<div class="col info font-color-000000 font-24 font-bold title">
					{{ totalTxs }} <span class="nrc20localizable" id="nrc20Subtitle"></span>
				</div>
			</div>
			...
			<div class="explorer-table-container">
				<table class="mt20 explorer-table list-table">
					<tr class="font-12 font-bold font-color-000000" style="height: 46px; background-color: #e8e8e8;">
						<th></th>
						<th class="nrc20localizable" id="nrc20TableTxHash"></th>
						<th class="nrc20localizable" id="nrc20TableBlock"></th>
						<th class="nrc20localizable" id="nrc20TableAge"></th>
						<th class="nrc20localizable" id="nrc20TableFrom"></th>
						<th></th>
						<th class="nrc20localizable" id="nrc20TableTo"></th>
						<th class="text-right nrc20localizable" id="nrc20TableValue"></th>
						<th class="text-right pr-3 nrc20localizable" id="nrc20TableTxFee"></th>
					</tr>
					...
					<tr v-for="(o, i) in arr" :key="i">
						...
						<td class="txs-block">
							...
							<i class="font-14 font-color-000000 nrc20localizable" v-else id="nrc20PendingText"></i>
						</td>

						<td class="time font-14 font-color-555555">
							<div>
								<div><span class="nrc20localizable" id="nrc20TimeStampPrefix"></span>{{ timeConversion(o.timeDiff) }}<span class="nrc20localizable" id="nrc20TimeStampSuffix"></span></div>
	...
	module.exports = {
		...
		methods: {
			...
			checkStaticTranslations() {
				...
				var myLocalizableElements = document.getElementsByClassName("nrc20localizable");
			...
			checkDynamicTranslations() {
				...
				var myMultiLocalizableElements = document.getElementsByClassName("nrc20multilocalizable");
