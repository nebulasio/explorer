...
module.exports = {
    ...
    data() {
        return {
            ...
            keyEstimatedLeftTime: "Estimated additional issuance time ",
            keyCurrentBlockHeight: "Current Block >",
            keyNextIssueBlockHeight: "Additional Issuance Block",
            keyLastNaxDistribution: "Dstribution of The Current Period",
