	...
	<div class="vue-contracts fullfill">
		<div class="vue-bread">
			<div class="container">
				<div class="row align-items-center">
					<div class="col-auto bread-title font-40 font-bold font-color-000000 contractslocalizable" id="contractsTitle"></div>
		...
		<div v-if="arr" class="container mt20">
			<div class="align-items-center info-and-pagination mt20 row">
				<div class="col info font-color-000000 font-24 font-bold title">{{ numberAddComma(totalCts) }} <span class="contractslocalizable" id="contractsSmartContractsFound"></span></div>
			...
			<div class="explorer-table-container font-14">
				<table class="mt20 explorer-table list-table">
					<tr class="list-header font-12 font-bold font-color-000000">
						<th style="padding-left: 24px;" class="contractslocalizable" id="contractsTableSmartContracts"></th>
						<th v-if="$route.params.api === 'testnet'" class="contractslocalizable" id="contractsTableCreatorAddress"></th>
						<th>Type</th>
						<th class="text-right contractslocalizable" style="padding-right: 24px; width: 120px" id="contractsTableDateCreated"></th>
					</tr>
	...
	module.exports = {
		...
		methods: {
			...
			checkStaticTranslations() {
				...
				var myLocalizableElements = document.getElementsByClassName("contractslocalizable");
			...
			checkDynamicTranslations() {
				...
				var myMultiLocalizableElements = document.getElementsByClassName("contractsmultilocalizable");
