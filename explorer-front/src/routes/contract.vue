		...
		<div class="container" v-if=obj>
			...
			<div class="explorer-table-container">
				<div class="font-color-000000 font-24 font-bold table-title">
					<span id="contractOverview" class="contractlocalizable"></span>
				</div>
				<table class="explorer-table font-16 d-none d-md-table">
					<tr>
						<td class="font-color-555555 td-left pl-16 contractlocalizable" id="contractTotalSupplyTitle"></td>
						<td class="font-color-000000">{{ tokenAmount(obj.total, decimal) }} {{ obj.tokenName }}</td>
					</tr>
					<tr v-if="tokenPrice">
						<td class="font-color-555555 pl-16 contractlocalizable" id="contractPriceTitle"></td>
						<td>
					...
					<tr>
						<td class="font-color-555555 pl-16 contractlocalizable" id="contractHoldersTitle"></td>
						<td class="font-color-000000">{{ numberAddComma(obj.holderCount) }} <span id="contractAddressesText" class="localizable"></span></td>
					</tr>
					<tr>
						<td class="font-color-555555 pl-16 contractlocalizable" id="contractTransfersTitle"></td>
						<td class="font-color-000000">{{ numberAddComma(obj.transactionCount) }}</td>
					</tr>
					<tr>
						<td class="font-color-555555 pl-16 contractlocalizable" id="contractContractTitle"></td>
						<td>
				...
				<div class="mobile-detail d-md-none">
					<div>
						<span class="contractlocalizable" id="contractTotalSupplyTitle2"></span>
						<div class="detail">{{ tokenAmount(obj.total, decimal) }} {{ obj.tokenName }}</div>
					</div>
					<div v-if="tokenPrice">
						<span class="contractlocalizable" id="contractPriceTitle2"></span>
						<div class="detail">
							<span class="font-color-000000">${{ tokenPrice.price }}</span>
							<span :class='{"font-color-07A656": tokenPrice.trends === 1, "font-color-F04434": tokenPrice.trends != 1}'>(</span>
					...
					<div>
						<span class="contractlocalizable" id="contractHoldersTitle2"></span>
						<div class="detail">{{ numberAddComma(obj.holderCount) }} addresses</div>
					</div>
					<div>
						<span class="contractlocalizable" id="contractTransfersTitle2"></span>
						<div class="detail">{{ numberAddComma(obj.transactionCount) }}</div>
					</div>
					<div>
						<span class="contractlocalizable" id="contractContractTitle2"></span>
						<div class="detail">
							<router-link v-bind:to='fragApi + "/address/" + obj.contract'>
								<span class="monospace">{{ obj.contract }}</span>
							</router-link>
			...
			<div class="tab" v-show="tab === 1">
				<div v-if="txs.length" class="d-block d-md-flex flex-row align-items-center">
					<div class="col mr-auto px-0 font-16 font-bold font-color-000000">
						...
						<span class="contractlocalizable" id="contractLatestText"></span> {{ txs.length }} {{ txs.length > 1 ? 'txs' : 'tx' }} <span class="contractlocalizable" id="contractFromTotalText"></span> {{ numberAddComma(obj.transactionCount) }} <span v-if="obj.transactionCount > 1" class="localizable" id="contractTransactionsText"></span><span v-else class="localizable" id="contractTransactionText"></span><span v-if="obj.pendingTransactionCount > 0">{{ '( + ' + obj.pendingTransactionCount }} <span v-if="obj.pendingTransactionCount == 1" id="contractPendingSingularText" class="contractlocalizable"></span><span v-else id="contractPendingPluralText" class="contractlocalizable">)</span>
						</span>{{  (obj.pendingTransactionCount > 1 ? 'txs )' : 'tx )') }}
					</div>
					<div class="col-auto px-0">
						<router-link class="d-block d-md-inline-block align-middle mt-1 mt-md-0" v-bind:to='fragApi + "/contract-txs?contract=" + $route.params.id'>
							<span class="font-16 contractlocalizable" id="contractViewAllText"></span>
						</router-link>
						<span v-if="obj.pendingTransactionCount > 0">
							...
							<router-link class="d-block d-md-inline-block align-middle mt-1 mt-md-0" v-bind:to='fragApi + "/contract-txs?contract=" + $route.params.id + "&isPending=true" '>
								<span class="font-16"><span id="contractViewAllText2" class="contractlocalizable"></span> {{ obj.pendingTransactionCount }} <span id="contractPendingText2" class="contractlocalizable"></span> <span v-if="obj.pendingTransactionCount > 1" id="contractPendingPluralText2" class="contractlocalizable"></span><span v-else id="contractPendingSingularText2" class="contractlocalizable"></span></span>
							</router-link>
						</span>
					</div>
				</div>
				...
				<div class="explorer-table-container">
					<table v-if="txs.length" class="mt20 explorer-table list-table">
						<tr class="font-color-000000 font-12 font-bold" style="height: 46px; background-color: #e8e8e8;">
							<th></th>
							<th class="contractlocalizable" id="contractTableTxHash"></th>
							<th class="contractlocalizable" id="contractTableBlock"></th>
							<th class="contractlocalizable" id="contractTableAge"></th>
							<th class="contractlocalizable" id="contractTableFrom"></th>
							<th></th>
							<th class="contractlocalizable" id="contractTableTo"></th>
							<th class="text-right contractlocalizable" id="contractTableValue"></th>
							<th class="text-right pr-3 contractlocalizable" id="contractTableTxFee"></th>
						</tr>
						...
						<tr v-for="o in txs" :key="o.hash">
							...
							<td class="txs-block">
								...
								<i class="font-14 font-color-000000 contractlocalizable" v-else id="contractPendingText3"></i>
							</td>
							<td class="time font-14 font-color-555555">
								<div>
									<div><span class="contractlocalizable" id="contractTimeDiffPrefix"></span> {{ timeConversion(o.timeDiff) }} <span class="contractlocalizable" id="contractTimeDiffSuffix"></span></div>
							...
							<td class="tdxxxwddd txs-from-to">
								<div v-if="o.type==='call'" class="container-tip">
									<span class="tip down-arrow-tip font-15 shadow contractlocalizable" id="contractSmartContractTitle"></span>
							...
							<td  class="text-right font-14 font-color-555555 pr-3">
								...
								<i v-else class="contractlocalizable" id="contractPendingText4"></i>
							</td>
						</tr>
					</table>
				</div>
				...
				<div v-if="txs.length" class="d-block d-md-flex flex-row align-items-center justify-content-end mt20">
					<div class="col-auto px-0">
						<router-link class="d-block d-md-inline-block align-middle mt-1 mt-md-0" v-bind:to='fragApi + "/contract-txs?contract=" + $route.params.id'>
							<span class="font-16"><span class="contractlocalizable" id="contractViewAllText3"></span> {{ obj.transactionCount }} {{ obj.transactionCount > 1 ? 'txs' : 'tx' }}</span>
						</router-link>
						<span v-if="obj.pendingTransactionCount > 0">
							<span class="d-none d-md-inline-block px-2">|</span>
							<router-link class="d-block d-md-inline-block align-middle mt-1 mt-md-0" v-bind:to='fragApi + "/contract-txs?contract=" + $route.params.id + "&isPending=true" '>
								<span class="font-16"><span class="contractlocalizable" id="contractViewAllText4"></span> {{ obj.pendingTransactionCount }} <span v-if="obj.pendingTransactionCount > 1" class="contractlocalizable" id="contractPendingTransactionsPlural"></span><span v-else class="contractlocalizable" id="contractPendingTransactionsSingular"></span></span>
							</router-link>
						</span>
					</div>
				</div>
			...
			<div class="tab" v-show="tab === 2">
				<div class="align-items-center info-and-pagination mt20 row">
					<div class="col font-16 font-bold font-color-000000">
						<span id="contractHoldersFoundPrefix" class="contractlocalizable"></span>{{ numberAddComma(totalHolderCount) }}<span id="contractHoldersFoundSuffix" class="contractlocalizable"></span>
					</div>
				</div>
				...
				<div class="explorer-table-container">
					<table v-if="holders.length" class="mt20 explorer-table list-table">
						<tr class="list-header font-12 font-bold font-color-000000">
							<th class="contractlocalizable" style="padding-left: 24px; width: 100px;" id="contractTableRank"></th>
							<th class="contractlocalizable" style="width: 30%" id="contractTableAddress"></th>
							<th class="text-right contractlocalizable" id="contractTableQuantity"></th>
							<th class="text-right contractlocalizable" style="padding-right: 24px;" id="contractTablePercentage"></th>
						</tr>
	...
	module.exports = {
		...
		methods: {
			...
			checkStaticTranslations() {
				...
				var myLocalizableElements = document.getElementsByClassName("contractlocalizable");
			...
			checkDynamicTranslations() {
				...
				var myMultiLocalizableElements = document.getElementsByClassName("contractmultilocalizable");
