    ...
    <div class="vue-dashboard">
        ...
        <div class="container">
                ...
                <div class="daily-transactions flex-item col-12 col-lg-6 row1-item">
                    <div class="item-bg">
                        <div class="item-title">
                            <span id="dashboardDailyTransactionsTitle"
                                  class="dashboardlocalizable"></span>

                        </div>
                        <div class="details">
                            <span id="dashboardDailyTransactionsSubtitle"
                                  class="dashboardlocalizable"></span>
                            <span v-if="todayTxCnt >= 0">{{ numberAddComma(todayTxCnt) }}</span>
                        </div>
                        <vchart class="daily-chart" v-if="dailyTxChartOptions"
                                :options="dailyTxChartOptions" :autoResize='true'></vchart>
                    </div>
                </div>
                <div class="nas-price flex-item col-12 col-lg-6 row1-item">
                    <div class="item-bg">
                        <div class="item-title"><span id="dashboardNasPriceTitle"
                                                      class="dashboardlocalizable"></span></div>
                        <div class="details">
                            <span id="dashboardNasPriceUpdateTimePrefix"
                                  class="dashboardlocalizable"></span> <span v-if="market">{{ timeConversion(Date.now() - market.createdAt) }}</span><span
                            id="dashboardNasPriceUpdateTimeSuffix"
                            class="dashboardlocalizable"></span>
                        </div>
                        ...
                        <div class="market container">
                            <div class="row">
                                <div class="col-6">
                                    <span id="dashboardNasMarketCap"
                                          class="dashboardlocalizable"></span>
                                    <div v-if="market">${{ numberAddComma(market.marketCap) }}</div>
                                </div>
                                <div class="col-6">
                                    <span id="dashboardNasMarketVol"
                                          class="dashboardlocalizable"></span>
            ...
            <div class="row row2">
                <div class="col">
                    <div class="flex-item item-bg item-shadow">
                        <div id="dashboardBlocksTitle"
                             class="dashboardlocalizable item-title"></div>
                        <div id="dashboardBlocksSubtitle"
                             class="dashboardlocalizable subtitle font-12 text-gray"></div>
                        <transition-group v-on:after-enter="afterEnter" name="row2-list"
                                          class="realtime-blocks">
                            <div class="realtime-block" v-for="block in blocks" :key="block.height">
                                <div class="blockheight" style="height: 100%"
                                     :data-txncnt="block.txnCnt"></div>
                                <div class="block-popover">
                                    <div class="font-12 font-bold">{{ numberAddComma(block.height)
                                        }}
                                    </div>
                                    <div><span name="dashboardBlocksTransactions"
                                               class="dashboardmultilocalizable"></span> {{
                                        block.txnCnt }}
                                    </div>
                                    <div><span name="dashboardBlocksInterval"
                                               class="dashboardmultilocalizable"></span></div>
                                </div>
                            </div>
                        </transition-group>
                    </div>
            ...
            <div class="row row3">
                <div class="col-lg-3 col-md-6 col-12 flex-item w285">
                    <div class="item-bg item-shadow">
                        ...
                        <router-link v-if="staticInfo" class="link link-style"
                                     :to='fragApi + "/blocks/"'>
                            <span id="dashboardBlocksHeightTitle"
                                  class="dashboardlocalizable"></span>
                        </router-link>
                ...
                <div class="col-lg-3 col-md-6 col-12 flex-item w285">
                    <div class="item-bg item-shadow">
                        ...
                        <router-link v-if="staticInfo" class="link link-style"
                                     :to='fragApi + "/txs/"'><span id="dashboardTotalTransactions"
                                                                   class="dashboardlocalizable"></span>
                        </router-link>
                ...
                <div class="col-lg-3 col-md-6 col-12 flex-item w285">
                    <div class="item-bg item-shadow">
                        <div v-if="staticInfo">{{ numberAddComma(staticInfo.totalContractCount) }}
                        </div>
                        <router-link v-if="staticInfo" class="link link-style"
                                     :to='fragApi + "/contracts/"'><span
                            id="dashboardTotalSmartContracts" class="dashboardlocalizable"></span>
                        </router-link>
                ...
                <div class="col-lg-3 col-md-6 col-12 flex-item w285">
                    <div class="item-bg item-shadow">
                        <div v-if="staticInfo">{{ numberAddComma(staticInfo.totalAddressCount) }}
                        </div>
                        <router-link v-if="staticInfo" class="link link-style"
                                     :to='fragApi + "/accounts/"'><span id="dashboardTotalAddresses"
                                                                        class="dashboardlocalizable"></span>
                        </router-link>
            ...
            <div class="row row4">
                <div class="flex-item col-12 col-lg-6 row4-item user-data">
                    <div class="item-bg item-shadow">
                        <div class="item-title">
                            <span id="dashboardNewAddressesPercentage"
                                  class="dashboardlocalizable"></span>
                            <div class="text-light-gray font-12 font-regular"><span
                                id="dashboardNewAddressesSubtitle"
                                class="dashboardlocalizable"></span></div>
                        ...
                        <div v-show="staticInfo" class="user-pie">
                            ...
                            <div class="new-user-container">
                                <transition name="new-user-pie">
                                    <div class="new-user"
                                         :style='staticInfo ? "transform: rotate(-" + staticInfo.newAddressCount / staticInfo.totalAddressCount * 360 + "deg)" : ""'></div>
                                </transition>
                            </div>
                            <div v-if="staticInfo" class="new-user-indicator d-none d-sm-block">
                                ...
                                <div class="labels">
                                    <!-- 四舍五入并保留一位小数 -->
                                    <div>{{ (Math.round(100 * staticInfo.newAddressCount /
                                        staticInfo.totalAddressCount * 10) / 10).toFixed(1) + '%' }}
                                    </div>
                                    <div><span id="dashboardNewAddresses"
                                               class="dashboardlocalizable">fefefe</span></div>
                                </div>
                            </div>
                        </div>
                        <div v-if="staticInfo" class="detail">
                            <!-- <div class="font-12 text-light-gray data-source">Data Sources: Nebulas</div> -->
                            <div class="title">{{ numberAddComma(staticInfo.newAddressCount) }}
                            </div>
                            <div class="font-12 text-gray"><span id="dashboardNewAddressesText"
                                                                 class="dashboardlocalizable"></span>
                            </div>
                            <div class="title">{{ numberAddComma(staticInfo.totalAddressCount) }}
                            </div>
                            <div class="font-12 text-gray"><span id="dashboardTotalAddressesText"
                                                                 class="dashboardlocalizable"></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex-item col-12 col-lg-6 row4-item accounts-data">
                    <div class="item-bg item-shadow">
                        <div class="item-title"><span id="dashboardAddressesGrowth"
                                                      class="dashboardlocalizable"></span></div>
                        <!-- <div v-if="accountsChartOptions" class="font-12 text-light-gray data-source">Data Sources: Nebulas</div> -->
                        <vchart class="accounts-chart" v-if="accountsChartOptions"
                                :options="accountsChartOptions" :autoResize='true'></vchart>
                    </div>
                </div>
            </div>
            <!--ATP mobile中间广告位-->
            ...
            <div class="row row5">
                <div class="flex-item col-12 col-lg-6 row5-item">
                    <div class="item-bg item-shadow">
                        <div class="item-title"><span id="dashboardBlocksIndicatorTitle"
                                                      class="dashboardlocalizable"></span></div>
                        <router-link :to='fragApi + "/blocks/"' class="showall"><span
                            name="dashboardIndicatorViewAll"
                            class="dashboardmultilocalizable"></span></router-link>
                        <transition-group name="list" tag="table" frame=hsides rules=rows>
                            <tr class="list-item" v-for="block in blocks.slice(0, 6)"
                                :key="block.height">
                                <td>
                                    <img src="/static/img/icon-block.png?v=20190116" width="50"
                                         height="50">
                                </td>
                                <td>
                                    <span name="dashboardBlockNumber"
                                          class="dashboardmultilocalizable"></span>
                                    <router-link :to='fragApi + "/block/" + block.height'
                                                 class="monospace">{{ block.height }}
                                    </router-link>
                                    <br>
                                    <span class="txcnt monospace">
										<router-link v-if="block.tx_count == 0"
                                                     :to='fragApi + "/txs?block=" + block.height'><span
                                            name="dashboardBlocksNoTransaction"
                                            class="dashboardmultilocalizable"></span></router-link>
										<router-link v-if="block.tx_count == 1"
                                                     :to='fragApi + "/txs?block=" + block.height'>{{ block.tx_count }} <span
                                            name="dashboardBlocksOneTransaction"
                                            class="dashboardmultilocalizable"></span></router-link>
										<router-link v-if="block.tx_count > 1"
                                                     :to='fragApi + "/txs?block=" + block.height'>{{ block.tx_count }} <span
                                            name="dashboardBlocksSeveralTransactions"
                                            class="dashboardmultilocalizable"></span></router-link>
									</span>
                                </td>
                                <td>
                                    <div class="time">{{ timeConversion(serverTime
                ...
                <div class="flex-item col-12 col-lg-6 row5-item">
                    <div class="item-bg item-shadow">
                        <div class="item-title"><span id="dashboardTransactionsTitle"
                                                      class="dashboardlocalizable"></span></div>
                        <router-link :to='fragApi + "/txs/"' class="showall"><span
                            name="dashboardIndicatorViewAll"
                            class="dashboardmultilocalizable"></span></router-link>
                        <transition-group name="list" tag="table" frame=hsides rules=rows>
                            <tr v-for="tx in txs.slice(0, 6)" :key="tx.hash">
                                <td>
                                    <img src="/static/img/icon-tx.png?v=20190116" width="50"
                                         height="50">
                                </td>
                                <td>
                                    <span name="dashboardTransactionNumber"
                                          class="dashboardmultilocalizable"></span>
                                    <router-link :to='fragApi + "/tx/" + tx.hash'>
                                        <span
                                            class="monospace">{{ tx.hash.slice(0, 4) }}</span>...<span
                                        class="monospace">{{ tx.hash.slice(-4) }}</span>
                                    </router-link>
                                    <br>
                                    <span class="fromto d-none d-sm-inline">
										<span name="dashboardTransactionFromText"
                                              class="dashboardmultilocalizable"></span>
										<router-link :to='fragApi + "/address/" + tx.from.hash'>
											<span
                                                class="monospace">{{ tx.from.hash.slice(0, 4) }}</span>...<span
                                            class="monospace">{{ tx.from.hash.slice(-4) }}</span>
										</router-link>
									</span>
                                    <span class="fromto d-none d-sm-inline">
										<span name="dashboardTransactionToText"
                                              class="dashboardmultilocalizable"></span>
										<router-link :to='fragApi + "/address/" + tx.from.hash'>
											<span
                                                class="monospace">{{ tx.to.hash.slice(0, 4) }}</span>...<span
                                            class="monospace">{{ tx.to.hash.slice(-4) }}</span>
										</router-link>
									</span>
                                </td>
                                <td>
                                    <div class="time">{{ timeConversion(Date.now() -
                                        tx.localTimestamp + tx.timeDiff) }}
                                    </div>
                                </td>
                            </tr>
                        </transition-group>
...
<script>
    ...
    module.exports = {
        ...
        mounted() {
            ...
            api.getTxDailyCount(o => this.dailyTxData = o);					 //近期每日交易量
            api.getMarketCap(o => this.market = o);								 //币价和市值
            api.getBlocks({page_size: "40"}, o => {
                this.serverTime = o.server_timestamp;
                this.blocks = this.addLocalTimestamp(o.list);
            ...
            api.getTxLatest(o => {
                this.txs = this.addLocalTimestamp(o);
            ...
            api.getTodayTxCnt(o => this.todayTxCnt = o.count);							//今日交易量
            api.getStaticInfo(o => {
                this.staticInfo = o;
            ...
            this.shortIntervalID = setInterval(() => {
                api.getTxLatest(o => this.txs = this.addLocalTimestamp(o));				   //最新一波 tx
                api.getBlocks({page_size: "40"}, o => {
                    this.serverTime = o.server_timestamp;
                    this.addLocalTimestamp(o.list);
                    try {
                        if (o.list[0].height != this.blocks[0].height) {
                            this.blocks.splice(0, 0, o.list[0]);
                        }
                    } catch (error) {
                    }
